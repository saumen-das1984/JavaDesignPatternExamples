package mediator.design.pattern.example;
...
public class MediatorPatternTest {
    public static void main(String [] arguments){
        ...
        Contact contact = new ContactImpl("Alex", "Tucker", "Developer", "Alexa");
        Contact contact1 = new ContactImpl("Brian", "Flower", "Content Writer", "10gen");
